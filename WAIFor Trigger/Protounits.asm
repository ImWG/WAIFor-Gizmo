...
.If DWord Ptr Ss:[Esp + 24H] == 0
	...
	.If Al <= Byte Ptr Ds:[Ebx + 04H]
		.If DWord Ptr Ss:[Esp + 1CH] == 2
			...
			Mov Ecx, Esi
			Call Protounit_GetResourceFloat
		.Else
...
Protounit_getArmorType:
	...
	Test Ebx, Ebx
	Je Protounit_getArmorType__
	Mov Ax, Word Ptr Ss:[Esp + 10H]

	.Repeat
		.If Ax == Word Ptr Ds:[Edi]
			Lea Eax, [Edi + 2H]
			Jmp Protounit_getArmorType_
		.EndIf
		Add Edi, 4
		Dec Ebx
	.Until Zero?
Protounit_getArmorType__:
	Xor Eax, Eax

Protounit_getArmorType_:
	Pop Ebx
	Pop Edi
	Pop Esi
	Retn 0CH
